...
function ContactMap() {
	...
	if (jQuery('#map_canvas').length > 0) {
		var latlng = new google.maps.LatLng(7.20830000, 79.83580000);
		var settings = {
			zoom: 15,
			disableDefaultUI: true,
			center: new google.maps.LatLng(7.20830000, 79.83580000),
		...
		var companyImage = new google.maps.marker.AdvancedMarkerElement('images/marker.png',
